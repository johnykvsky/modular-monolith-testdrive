 ...
 */
final class Version20220205205738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item CHANGE id id CHAR(36) COMMENT \'(DC2Type:uuid)\' NOT NULL, CHANGE parent_id parent_id CHAR(36) COMMENT \'(DC2Type:uuid)\' DEFAULT NULL, CHANGE category_id category_id CHAR(36) COMMENT \'(DC2Type:uuid)\' DEFAULT NULL, CHANGE translator translator VARCHAR(250) DEFAULT NULL, CHANGE cover_type cover_type VARCHAR(250) DEFAULT NULL, CHANGE edition_number edition_number INT DEFAULT NULL, CHANGE info_url info_url VARCHAR(250) DEFAULT NULL, CHANGE tags tags VARCHAR(250) DEFAULT NULL');
    }
